...
?>
    <meta http-equiv="refresh" content="2;url=http://www.proculgames.com/application%20submitted.html" />
<?php 
}
    else
    {
		//The user has failed the captcha, show error.
		header('index.php?CaptchaFail=true');
    }
}
?>